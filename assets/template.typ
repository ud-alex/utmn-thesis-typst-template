...
#import "@preview/theorion:0.6.0": show-theorion, set-theorion-numbering
...
#let project(project_data, body) = {
  ...
  show heading.where(level: 1): it => { eq_numbering_intrachapter.update(0); it }
  ...
  let numbering_style = { 
    if project_data.numbering_by_default { it => it } 
